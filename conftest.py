"""Makes `import parser_config` work no matter how pytest is started, and shares fixtures."""
import json
import shutil
import sys
...
def workdir(tmp_path):
    """A scratch copy of the config inputs, so tests can modify them freely."""
...
def built_config(workdir):
    """A freshly built config file (path) made from the real inputs."""
